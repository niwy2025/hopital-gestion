...
public class HospitalStockEntity {
    ...
    public HospitalStockEntity(UUID id, UUID hospitalId, String hospitalCode, MedicineEntity medicine, int quantity,
            int reorderLevel, BigDecimal unitCost, Currency currency, Instant updatedAt) {
    ...
    public void receive(int incomingQuantity, BigDecimal unitCost, int nextReorderLevel, Instant receivedAt) {
