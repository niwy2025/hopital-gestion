...
FROM (VALUES
    ('PRESCRIPTION_READ', 'Consulter les ordonnances d''un passage'),
    ('PRESCRIPTION_EXTERNAL_WRITE', 'Enregistrer une ordonnance externe'),
    ('PHARMACY_DISPENSE', 'Enregistrer la délivrance de médicaments')
...
FROM (VALUES
    ('ADMIN', 'PRESCRIPTION_READ'),
    ('ADMIN', 'PRESCRIPTION_WRITE'),
    ('ADMIN', 'PRESCRIPTION_EXTERNAL_WRITE'),
    ('ADMIN', 'PHARMACY_DISPENSE'),
    ('DOCTOR', 'PRESCRIPTION_READ'),
    ('NURSE', 'PRESCRIPTION_READ'),
    ('PHARMACIST', 'PATIENT_READ'),
    ('PHARMACIST', 'PRESCRIPTION_READ'),
    ('PHARMACIST', 'PRESCRIPTION_EXTERNAL_WRITE'),
